...
def model_predict(image_path):
    model = tf.keras.models.load_model(r"D:/PRAHAR_PLANT_DISEASE_DETECTION/Prahar_CNN_Plant_Disease_Detection_Model.keras")
...
img = Image.open(r"D:/PRAHAR_PLANT_DISEASE_DETECTION/test/test/AppleCedarRust4.JPG")
